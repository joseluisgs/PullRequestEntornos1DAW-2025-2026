...
al usuario una temperatura en grados Celsius (decimal). Utiliza el operador ternario (? :) anidado 
para asignar el resultado (string o decimal) basado en estas condiciones:
